...
export const ShortDataReport = ({ addedRaports, cadNumber, summa, arrayOfprice, activate, sendActivePromoCode, promoCode, setPromoCode, setActivate, isVisible, check, polygonCoordinates }) => {
  ...
  if (polygonCoordinates) {
      ...
      const link = `https://gcadastr.su/view/${encodedPolygon}`;
  ...
  return (
    ...
    <div className={style["oform-recip-cad"]}>Объект: {cadNumber}</div>
      ...
      {addedRaports.length !==0 &&
        ...
        <div className={style["oform-recip-footertext"]}>Заказ: {order}<span>cadmap.su</span></div>
      }
    </div>
