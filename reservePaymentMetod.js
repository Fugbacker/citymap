...
const { mailer } = require('./config/nodemailer1')
...
module.exports = {
  askserver: async function askserver() {
  ...
  const objectList = await collection.find({$and : [{status: null}, {mailSend: null}, {sale: 'false'}]}).toArray()

    if (objectList.length >= 1) {
      Promise.all(
        objectList.map(async (it) => {
          // const signatureValue = md5(`${merchantLogin}:${it.summa - (it.summa / 100 * parseFloat(persent))}:${it.orderNumber}:jkhfg8d1983`)
          const message = {
            from: 'Кадастровый сервис cadmap.su <admin@cadmap.su>',
            to: it.email,
            subject: `Скидка 20% на заказ №${it.orderNumber} на сайте cadmap.su`,
            html: `
                                          ...
                                          <tr>
                                            <td class="pc-menu-logo-s2" align="center" style="vertical-align: top; padding: 30px 40px 31px;" valign="top">
                                              <table border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 130px;" width="40">
                                                <tbody>
                                                  <tr>
                                                    <td style="vertical-align: top;" valign="top"> <a href="https://cadmap.su" style="text-decoration: none;">
                                                    <img src="https://cadmap.su/images/bigLogo.jpg" width="186" height="47" alt="" style="border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; font-weight: 500; color: #ffffff;">
                                                </a> </td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                          ...
                                          <tr>
                                            <td class="pc-cta-box-in" style="vertical-align: top; padding: 42px 40px 35px;" valign="top">
                                              <table class="pc-cta-s1" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                                <tbody>
                                                  <tr>
                                                    <td class="pc-cta-title pc-fb-font" style="vertical-align: top; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 28px; font-weight: 900; line-height: 1.28; /*! letter-spacing: -0.6px; */ color: #151515; text-align: justify;" valign="top" align="center">Ваша скидка 20% на заказ №${it.orderNumber}  </td>
                                                  </tr>
                                                  <tr>
                                                  ...
                                                  <tr>
                                                    <td class="pc-cta-text pc-fb-font" style="/*! vertical-align: top; */ font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 1.56; color: #9B9B9B; text-align: justify;/*! display: flex; */" valign="top" align="center">Здравствуйте. Вы  интересовались отчетами по объекту с кадастровым номером №${it.cadastrNumber}. Остался один шаг — оплата.
                                                      <br>
                                                      <br>
                                                      После оплаты ${it.summa - (it.summa / 100 * parseFloat(persent))} руб. (вместо ${it.summa} руб.) заказ поступит в работу, а отчёт, по готовности будет отправлен вам на email ${it.email}.
                                                      <br>
                                                      <br>
                                                  ...
                                                  <tr>
                                                    <td style="vertical-align: top; padding: 5px 0;" valign="top" align="center">
                                                      <table border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                                        <tbody>
                                                          <tr>
                                                            <td style="vertical-align: top; border-radius: 8px; text-align: center; background-color: #2d3c5f;" valign="top" bgcolor="#1595E7" align="center"> <a href=${`https://cadmap.su/discount/${it.orderNumber}|${it.summa - (it.summa / 100 * parseFloat(persent))}`} style="line-height: 1.5; text-decoration: none; margin: 0; padding: 13px 17px; white-space: nowrap; border-radius: 8px; font-weight: 500; display: inline-block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; cursor: pointer; background-color: #1595E7; color: #ffffff; border: 1px solid #1595E7;">Получить скидку</a></td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                    </td>
                                                      ...
                                                      <td style="vertical-align: top; padding: 20px;" valign="top">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="pc-footer-text-s1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                              <td class="pc-fb-font" style="vertical-align: top; padding: 11px 0 0; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.43; letter-spacing: -0.2px; color: #D8D8D8;" valign="top"> <a style="text-decoration: none; cursor: text; color: #D8D8D8;">cadmap.su</a> </td>
                                                            </tr>
                                                          </tbody>
                                                        </table>
                                                        <table border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                                          <tbody>
                                                            <tr>
                                                              <td class="pc-fb-font" style="vertical-align: top; padding: 9px 0 0; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 500; line-height: 1.7;" valign="top"> <a href="mailto:bo.grady@nathen.biz" style="text-decoration: none; color: #1595E7;">admin@cadmap.su</a> </td>
                                                            </tr>
                                                          </tbody>
                                                        </table>
                                                      </td>
          ...
          // async function sendEmailWithDelay(message, delay) {
          ...
          // await sendEmailWithDelay(message, 5000)
          await mailer(message)
          await collection.updateOne({orderNumber: it.orderNumber}, { $set: {mailSend: true}})
          console.log('передали письмо в mailer')
          return
        })
      )
      return
