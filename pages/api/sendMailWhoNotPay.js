...
export default async function askserver(req, res) {
                                                ...
                                                <tr>
                                                  <td style="vertical-align: top; padding: 5px 0;" valign="top" align="center">
                                                    <table border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                                      <tbody>
                                                        <tr>
                                                          <td style="vertical-align: top; border-radius: 8px; text-align: center; background-color: #2d3c5f;" valign="top" bgcolor="#1595E7" align="center"> <a href=${`https://auth.robokassa.ru/Merchant/Index.aspx?MerchantLogin=${merchantLogin}&OutSum=${it.summa - (it.summa / 100 * parseFloat(persent))}&InvoiceID=${it.orderNumber}&Description=${it.orderNumber}&SignatureValue=${signatureValue}`} style="line-height: 1.5; text-decoration: none; margin: 0; padding: 13px 17px; white-space: nowrap; border-radius: 8px; font-weight: 500; display: inline-block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; cursor: pointer; background-color: #1595E7; color: #ffffff; border: 1px solid #1595E7;">Перейти к оплате</a> </td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                  </td>
